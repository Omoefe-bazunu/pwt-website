  ...
  return (
    <div className="HeroSection-Wrapper flex justify-start items-center w-full  h-fit ">
        <div className="Hero-Inner py-20 px-52 h-full text-white w-full flex justify-center items-center gap-y-1 flex-col bg-cover bg-center bg-no-repeat">
            ...
            <p className="text-wrap w-11/12 text-xl text-center mt-5 mb-5">We make sure to give our clients value that will make them come back for more patronage and recommend our services.</p>
            <div className="Btn-border py-1 px-4 border-white border rounded-3xl">
                <p className="CTA-Btn bg-yellow-300 px-12 py-2 rounded-3xl text-slate-800 font-medium cursor-pointer">GET STARTED</p>
            </div>
        </div>
    </div>
  )
