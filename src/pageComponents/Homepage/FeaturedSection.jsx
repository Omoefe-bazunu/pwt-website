  ...
  return (
    <div className="Featured-Wrapper flex justify-start items-center flex-col h-fit w-full bg-yellow-50">
        <div className="Services-Inner w-5/6 ">
            ...
            <div className="Books flex justify-between items-center mt-10 mb-24">
                <BooksTemplates title="RIVER SIDE"/>
                <BooksTemplates title="HOPE"/>
                <BooksTemplates title="BIRTH PLACE"/>
                <BooksTemplates title="RISING FROM INSIDE"/>
            </div>
        </div>
    </div>
  )
