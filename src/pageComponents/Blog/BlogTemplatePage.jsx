...
function BlogTemplate({main, sub1, p1, sub2, p2,  postId, sub3, p3, sub4, p4, sub5, p5,  sub6, p6, sub7, p7, sub8, p8, sub9, p9, sub10, p10, sub11, p11, sub12, p12, sub13, p13, bLineTitle, bLine, otherPosts, Img1, category, date}) {
    ...
    <div className="Blog-Wrapper flex gap-10 justify-start h-full w-5/6 my-0 mx-auto py-12 ">
        <div className="BlogPosts h-fit w-full mb-12">
          <div className="Post mb-2 pr-8 pb-5 border-b border-slate-400 ">
              ...
              <p className="Date text-gray-500 mb-12 text-sm">{date}</p>
              ...
              <p className='paragraph-one my-3 text-gray-600'>{p1}</p>
              {/* <p className="Ul-list1 my-3 text-gray-600 list-item ml-10" id='ul1'></p>
              <p className="Ol-list1 my-3 text-gray-600" id='ol1'></p> */}
              ...
              <p className='p2 my-3 text-gray-600'>{p2}</p>
              {/* <p className="Ul-list2 my-3 text-gray-600" id='ul2'></p>
              <p className="Ol-list2 my-3 text-gray-600" id='ul2'></p> */}
              <img src="" alt="" className=" w-96 bg-slate-300 h-64 my-8 hidden" />
              <h3 className='p3Title text-xl font-medium text-gray-600'>{sub3}</h3>
              <p className='p3 my-3 text-gray-600'>{p3}</p>
              {/* <p className="Ul-list3 my-3 text-gray-600" id='ul3'></p>
              <p className="Ol-list3 my-3 text-gray-600" id='ul3'></p> */}
              <img src="" alt="" className=" w-96 bg-slate-300 h-64 my-8 hidden" />
              <h3 className='p4Title text-xl font-medium text-gray-600'>{sub4}</h3>
              <p className='p4 my-3 text-gray-600'>{p4}</p>
              {/* <p className="Ul-list4 my-3 text-gray-600" id='ul4'></p>
              <p className="Ol-list4 my-3 text-gray-600" id='ul4'></p> */}
              <img src="" alt="" className=" w-96 bg-slate-300 h-64 my-8 hidden" />
              <h3 className='p5Title text-xl font-medium text-gray-600'>{sub5}</h3>
              <p className='p5 my-3 text-gray-600'>{p5}</p>
              <img src="" alt="" className=" w-96 bg-slate-300 h-64 my-8 hidden" />
              <h3 className='p6Title text-xl font-medium text-gray-600'>{sub6}</h3>
              <p className='p6 my-3 text-gray-600'>{p6}</p>
              <img src="" alt="" className=" w-96 bg-slate-300 h-64 my-8 hidden" />
              <h3 className='p7Title text-xl font-medium text-gray-600'>{sub7}</h3>
              <p className='p7 my-3 text-gray-600'>{p7}</p>
              <img src="" alt="" className=" w-96 bg-slate-300 h-64 my-8 hidden" />
              <h3 className='p8Title text-xl font-medium text-gray-600'>{sub8}</h3>
              <p className='p8 my-3 text-gray-600'>{p8}</p>
              <img src="" alt="" className=" w-96 bg-slate-300 h-64 my-8 hidden" />
              <h3 className='p9Title text-xl font-medium text-gray-600'>{sub9}</h3>
              <p className='p9 my-3 text-gray-600'>{p9}</p>
              <img src="" alt="" className=" w-96 bg-slate-300 h-64 my-8 hidden" />
              <h3 className='p10Title text-xl font-medium text-gray-600'>{sub10}</h3>
              <p className='p10 my-3 text-gray-600'>{p10}</p>
              <img src="" alt="" className=" w-96 bg-slate-300 h-64 my-8 hidden" />
              <h3 className='p11Title text-xl font-medium text-gray-600'>{sub11}</h3>
              <p className='p11 my-3 text-gray-600'>{p11}</p>
              <img src="" alt="" className=" w-96 bg-slate-300 h-64 my-8 hidden" />
              <h3 className='p12Title text-xl font-medium text-gray-600'>{sub12}</h3>
              <p className='p12 my-3 text-gray-600'>{p12}</p>
              <img src="" alt="" className=" w-96 bg-slate-300 h-64 my-8 hidden" />
              <h3 className='p13Title text-xl font-medium text-gray-600'>{sub13}</h3>
              <p className='p13 my-3 text-gray-600'>{p13}</p>
              {/* <p className="Ul-list5 my-3 text-gray-600" id='ul5'></p>
              <p className="Ol-list5 my-3 text-gray-600" id='ul5'></p> */}
              <img src="" alt="" className=" w-96 bg-slate-300 h-64 my-8 hidden" />
              <h3 className='bottomLineTitle mb-2 font-medium text-xl text-gray-600'>{bLineTitle}</h3>
              <p className='bottomLine mb-5 text-gray-600'>{bLine}</p>
          </div>
           <BlogResponse id = {postId} />
