...
function CareerBlogPost() {
  ...
  //     const imageRef = ref(storage, 'images/BlogPostImages/careerMain.jpg'); // Replace with the actual path to your image in Firebase Storage
  //     try {
  ...
  // }, []); // Run this effect only once when the component mounts
    ...
    const category = 'Career'
            ...
            const fetchData = async () => {
                const q = query(collection(dbase, 'Career'), orderBy('CreatedAt'));
